...
try:
	...
	print("Exception in spinup.__init__ while trying to import tensorflow algos. Make sure to install tensorflow if you want to use it. Exception was:\n{}".format(ex))
...
try:
	...
	print("Exception in spinup.__init__ while trying to import pytorch algos. Make sure to install pytorch if you want to use it. Exception was:\n{}".format(ex))
